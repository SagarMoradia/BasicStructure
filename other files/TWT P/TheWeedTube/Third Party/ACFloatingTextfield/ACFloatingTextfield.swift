...
//    }
    ...
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        return CGRect(x:insetX, y:insetY, width:bounds.size.width, height:bounds.size.height);
    }
    ...
    public func showErrorWithText(errorText : String) {
        ...
        self.labelErrorPlaceholder?.textColor = UIColor.clear
        showingError = true;
        self.showErrorPlaceHolder();
    }
...
extension ACFloatingTextfield {
    ...
    func addFloatingLabel(){
        ...
        //IMHKS
        let leadingConstraint = NSLayoutConstraint.init(item: labelPlaceholder!, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: insetX)
    ...
    //MARK:- Float & Resign
    public func floatTheLabel() -> Void {
